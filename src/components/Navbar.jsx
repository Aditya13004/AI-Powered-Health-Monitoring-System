      ...
      <div className="container-custom">
        <div className="flex h-16 items-center justify-between gap-4">
          ...
          <Link to="/" className="flex items-center gap-2.5 group flex-shrink-0">
            ...
            <span className="font-extrabold text-xl tracking-tight gradient-text group-hover:scale-105 transition-transform duration-300">
              HealthSync
            </span>
          </Link>
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            ...
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="lg:hidden p-2 rounded-xl bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 hover:bg-slate-200 dark:hover:bg-slate-700 transition-all duration-300"
          ...
          >
            <div className="px-4 py-5 space-y-1">
              ...
              <div className="pt-3 border-t border-slate-200 dark:border-slate-700 space-y-2">
                {user ? (
                  <>
                    <p className="text-sm text-slate-500 dark:text-slate-400 px-3">Hi, {displayName}</p>
